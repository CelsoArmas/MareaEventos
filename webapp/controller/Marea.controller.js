sap.ui.define([
    ...
    return MainComp.extend("com.tasa.mareaevento.controller.Marea", {
        onInit: async function () {
            ...
            var oListaPlantas = that.getOwnerComponent()._getPropertiesToPropagate().oModels.ModeloPlantasModel; 
            var oConstantsModel = that.getOwnerComponent()._getPropertiesToPropagate().oModels.ModeloConstants;      
            //pprincipe fin
            //BusyIndicator.show(0);
            ...
            this.getModelo("DetalleMarea").setData(dataModelo);
            this.getModelo("DetalleMarea").refresh();

            var appName = this.getModelo("DetalleMarea").getProperty("/Utils/AppName");
            if(appName == "RegEventosPesca"){
                this.getModelo("ListaMareas").setData(oListaModelo);
                this.getModelo("ListaMareas").refresh();
                this.getModelo("PlantasModel").setData(oListaPlantas);
                this.getModelo("PlantasModel").refresh();
                this.getModelo("ConstantsUtility").setData(oConstantsModel);
                this.getModelo("ConstantsUtility").refresh();
            }else if(appName == "ConsultaMareas"){
                //llamar servicio de israel para validar la botonera de reabrir y guardar
                //cargar datos de la mnarea
